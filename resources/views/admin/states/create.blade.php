...
$(document).ready(function(){
 ...
 $(document).on('change','.country_id',function(){
  ...
  {
    $.ajax({
      url:'{{ aurl('/states/create') }}', ///the url i stand on it (current url)
      type:'get',
      dataType:'html',
  ...
  <div class="box-body">
    {!! Form::open(['url'=>aurl('/states')]) !!}
     ...
     <div class="form-group">
        ...
        {!! Form::select('country_id',App\Model\Country::pluck('country_name_ar','id'),old('country_id'),['class'=>'form-control country_id','placeholder'=>'.............']) !!}
     </div>
